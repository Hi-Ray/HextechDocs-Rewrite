  ...
  return (
    <Layout title="Hextech Docs" description="" image={Logo} tags="">
      ...
      <div className="home-container">
        ...
        <div className="home-section">
          <img
            src="https://images.contentstack.io/v3/assets/blt731acb42bb3d1659
            /bltfe81204b8ec63e0e/5e6184a918d3347ceffbbd6d/TFT.S3_GALAXIES.ARTICLE-2.jpg"
            alt=""
          />
        ...
        <div className="home-section">
          <img
            src="https://technology.riotgames.com/sites
            /default/files/articles/98/apitransformsheader.png"
            alt=""
          />
        </div>
      </div>
